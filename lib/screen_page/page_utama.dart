...
import 'package:notescrud1/model/model_notes.dart';
import 'package:notescrud1/screen_page/page_detil.dart';
import 'package:notescrud1/screen_page/page_edit.dart';
import 'package:notescrud1/screen_page/page_insert.dart';
...
class _PageUtamaState extends State<PageUtama> {
  ...
  Future<void> getNotes() async {
    try {
      var response = await http.get(Uri.parse('http://192.168.158.29/notesDB/getNotes.php'));
  ...
  Future<void> deleteNote(String id) async {
    try {
      var response = await http.post(
        Uri.parse('http://192.168.158.29/notesDB/deleteNote.php'),
        body: {'id': id},
      );
      var jsonData = json.decode(response.body);
